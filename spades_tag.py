...
#'E:\資策會-DB106\專題\Instagram'
path_dir = 'E:\專題\spades' # 手動更改
if not os.path.exists(path_dir):
    os.mkdir(path_dir)

path_shortcode = ''
shortcode_list = []
end_cursor = 'QVFESHlIWjE2UGdldHFnZlJVS3B0bEphODdKUHh5M3NuanUwR0lhSHRnLWxCT2dXa3FQaWxrMGp6c0ZfaXBjSWtEcXZFN25ueUYxR1Izb0tiS0dtXy1yRg==' # 手動更改
has_next_page = True
each_article_url = ''
...
def main(): #主程式  # 爬蟲 for Instagram
    ...
    # 開紀錄shortcode文字檔
    global path_shortcode,shortcode_list
    ...
    if  os.path.exists(path_shortcode):
        with open(path_shortcode , 'r', encoding='utf8') as f:
            ...
            shortcode_list =[row.replace('\n','') for row in all_shortcode]
